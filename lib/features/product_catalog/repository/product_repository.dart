...
abstract class IProductRepository {
  ...
  Future<Either<ProductFailure, ({List<Product> productList, PaginationData paging})>> searchProduct({String keyword = "", int skip = 0, int limit = 20});
}
...
class ProductRepository implements IProductRepository {
  ...
  @override
  Future<Either<ProductFailure, ({List<Product> productList, PaginationData paging})>> searchProduct({String keyword = "", int skip = 0, int limit = 20}) async {
    try{
      final result = await api.searchProductKeyword(
        keyword: keyword,
        skip: skip,
        limit: limit,
      );
